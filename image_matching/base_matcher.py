...
from image_matching import get_matcher
from image_matching.utils import (
...
class BaseMatcher(torch.nn.Module):
    ...
    def forward(
        self, img0: torch.Tensor | str | Path, img1: torch.Tensor | str | Path
    ) -> dict:
        """
        ...
        H, inlier_kpts0, inlier_kpts1 = self.process_matches(
...
class EnsembleMatcher(BaseMatcher):
    ...
    def _forward(self, img0, img1):
        ...
        all_matched_kpts0, all_matched_kpts1 = np.concatenate(
            all_matched_kpts0
        ), np.concatenate(all_matched_kpts1)
